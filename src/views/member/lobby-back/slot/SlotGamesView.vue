      ...
      <div class="justify-content-center d-flex">
        <div class="container-fluid">
          ...
          <div class="row p-2" v-if="slotOnesoft">
            <div class="col-6 col-sm-3 col-lg-2 p-2" v-for="item in slotOnesoft.gamesList" :key="item"
...
export default {
  ...
  methods: {
    ...
    async getgame() {  // new function 10/10/23
      const datagames = await this.games.gameList('slot');
      this.slot = datagames.data.find((e) => e.provider === this.$route.params.name)
    },
    async getonesoft() {   // new function 10/10/23
      const Onesoft = await this.gameOnesoft.getGameAll()
      console.log('Onesoft', Onesoft);
