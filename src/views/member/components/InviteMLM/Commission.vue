<template>
    <div class="">
        <h5 class="pt-3 text-white d-block">สรุปรายได้คอมมิชชั่น</h5>
        <div class="row ">
            <div class="col-12 col-sm-4 p-0 m-0">
                <div class="card card-member p-3 text-white m-2 stcard">
                    <div>
                        ...
                        <span class="text-base">{{ formatNumber(this.winloseStore.com.summary.Share * 100, 2) }}
                            %
                        </span>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-4 p-0 m-0">
                <div class="card card-member p-3 text-white m-2 stcard">
                    <div>
                        <p style="font-size: 15px">ยอดคอมมิชชั่น</p>
            ...
            <div class="col-12 col-sm-4 p-0 m-0">
                <div class="card card-member p-3 text-white m-2 stcard">
                    <div>
                        <p style="font-size: 15px">รายได้จากคอมมิชชั่น</p>
